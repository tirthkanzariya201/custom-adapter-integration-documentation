...
title: AppLovin MAX
description: >-
  AppLovin MAX Android guide for Custom Adapter (GMA Next-Gen SDK).
---
...
```
dependencies {
    implementation("io.github.tapmind-tech:customadapter-applovin-nextgen:2.0.0")
...
Refer [AppLovin MAX Mediation Integration Setup](/reference/mediation-integration-setup/applovin-max) for the integration.
