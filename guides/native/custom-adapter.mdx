...
description: >-
  Native integration guide for TapMind Custom Adapter GMA SDK across AdMob, Google Ad Manager, AppLovin, IronSource LevelPlay.
---
...
```
dependencies {
    // Add TapMind SDK AppLovin Adapter dependency
