...
description: >-
  Native integration guide for TapMind Custom Adapter GMA SDK across AdMob, Google Ad Manager, AppLovin MAX, IronSource LevelPlay.
---
...
implementation("io.github.tapmind-tech:customadapter-admob:2.1.12")
...
implementation("io.github.tapmind-tech:customadapter-gam:2.1.12")
...
```
dependencies {
    // Add TapMind SDK AppLovin MAX Adapter dependency
implementation("io.github.tapmind-tech:customadapter-applovin:2.1.12")
    // Add GMA SDK dependency
    implementation ("com.google.android.gms:play-services-ads:25.0.0")
}
```
...
```
dependencies {
    // Add TapMind SDK IronSource Adapter dependency
implementation("io.github.tapmind-tech:customadapter-ironsource:2.1.12")
    // Add GMA SDK dependency
    implementation ("com.google.android.gms:play-services-ads:25.0.0")
}
```
