---
description: >-
  Flutter Android integration guide for TapMind Next-Gen SDK across AdMob, Google Ad Manager, AppLovin MAX, and IronSource LevelPlay.
---
...
- [Installation](https://tapminds.gitbook.io/next-gen-sdk-integration/next-gen-integration-sdk/flutter-android-engine/applovin/installation.md)
- [Configuration](https://tapminds.gitbook.io/next-gen-sdk-integration/next-gen-integration-sdk/flutter-android-engine/applovin/configuration.md): This is guide to set up TapMind with applovin using custom networks
