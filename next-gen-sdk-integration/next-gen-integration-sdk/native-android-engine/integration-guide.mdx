---
description: >-
  Native Android integration guide for TapMind Next-Gen SDK across AdMob, Google Ad Manager, AppLovin MAX, and IronSource LevelPlay.
---
...
implementation("io.github.tapmind-tech:customadapter-admob-nextgen:2.0.0")
...
dependencies {
    // Add TapMind SDK AdMob Adapter dependency
implementation("io.github.tapmind-tech:customadapter-gam-nextgen:2.0.0")
    // Add AdMob SDK dependency
    implementation ("com.google.android.gms:play-services-ads:25.0.0")
}
```
...
Class Name : com.tapmind.mediation.ng.TapMindGamAdapter
Parameter : { "placementName": "As Per the G-sheet Provided" }
```
